...
public class CircularProgressBar extends View {
    ...
    private void drawText(Canvas canvas) {
        mPaint.setTextSize(Math.min(mViewWidth, mViewHeight) / 7f);
        ...
        canvas.drawText(calcProgressFromSweepAngle(mSweepAngle) +"/1000", xPos, yPos-100, mPaint);
        canvas.drawText("Steps", xPos, yPos+50, mPaint);
    }
